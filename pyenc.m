function [x1,x2,x3,x4,y0,y1,y2,y3] = pyenc(X, h)
    ...
    y1_bits = h_y0 * length(y1(:));
    y2_bits = h_y0 * length(y2(:));
    y3_bits = h_y0 * length(y3(:));
